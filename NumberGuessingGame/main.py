...
# Defining a list of dot characters to be used to simulate loading effect
load_list = ['.','.','.','.']

def loading():
    """Simulates a loading animation by printing a sequence of characters in a single line with a delay
...
def game():
    """Manages the entire flow of the Number Guessing Game.

    Returns:
        None: The function does not return anything. It loops until the player decides to stop playing the game.
    """
            ...
            while True:
                ...
                if (player_choice in range(1,101)) and (comp_choice in range(1,101)):
                    while player_choice != comp_choice:
                        ...
                        print(f"\n\t\tCONGRATULATIONS! You guessed {comp_choice} correct!")
