...
# Setup Color Options
def red(skk):
    sys.stdout.write("\033[91m {}\033[00m" .format(skk))
def green(skk):
    sys.stdout.write("\033[92m {}\033[00m" .format(skk))
def yellow(skk):
    sys.stdout.write("\033[93m {}\033[00m" .format(skk))
def lightpurple(skk):
    sys.stdout.write("\033[94m {}\033[00m" .format(skk))
def purple(skk):
    sys.stdout.write("\033[95m {}\033[00m" .format(skk))
